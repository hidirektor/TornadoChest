package com.infumia.t3sl4.util.nbt.nms.v1_13_R2.compound;

import com.infumia.t3sl4.util.nbt.nms.v1_13_R2.NBTBaseEnvelope;
import com.infumia.t3sl4.util.nbt.nms.v1_13_R2.base.NBTStringOf;
import com.infumia.t3sl4.util.nbt.nms.v1_13_R2.list.NBTByteListOf;
import com.infumia.t3sl4.util.nbt.nms.v1_13_R2.list.NBTLongListOf;
...
import com.infumia.t3sl4.util.nbt.nms.v1_13_R2.number.NBTDoubleOf;
import com.infumia.t3sl4.util.nbt.api.mck.MckNBTBase;
import com.infumia.t3sl4.util.nbt.api.mck.NBTEndOf;
import com.infumia.t3sl4.util.nbt.nms.v1_13_R2.list.NBTIntListOf;
            ...
            new Mapped<>(
                value -> {
                    ...
                    switch (base.getTypeId()) {
                        ...
                        case 1:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_13_R2.number.NBTByteOf((NBTTagByte) base));
                        case 2:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_13_R2.number.NBTShortOf((NBTTagShort) base));
                        case 3:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_13_R2.number.NBTIntOf((NBTTagInt) base));
                        case 4:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_13_R2.number.NBTLongOf((NBTTagLong) base));
                        case 5:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_13_R2.number.NBTFloatOf((NBTTagFloat) base));
                        case 6:
                        ...
                        case 9:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_13_R2.list.NBTTagListOf((NBTTagList) base));
                        case 10:
