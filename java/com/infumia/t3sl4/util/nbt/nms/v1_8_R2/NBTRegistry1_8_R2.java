package com.infumia.t3sl4.util.nbt.nms.v1_8_R2;
...
import com.infumia.t3sl4.util.nbt.nms.v1_8_R2.compound.NBTCompoundOf;
...
public class NBTRegistry1_8_R2 implements NBTRegistry {

    @NotNull
    @Override
    public ItemStack toItemStack(@NotNull NBTCompound nbtCompound) {
        return CraftItemStack.asBukkitCopy(
            net.minecraft.server.v1_8_R2.ItemStack.createStack(
                getTag(
    ...
    public NBTCompound toCompound(@NotNull org.bukkit.entity.Entity entity) {
        net.minecraft.server.v1_8_R2.Entity nms = ((CraftEntity)entity).getHandle();
    ...
    public org.bukkit.entity.Entity toEntity(@NotNull Entity original, @NotNull NBTCompound applied) {
        net.minecraft.server.v1_8_R2.Entity nms = ((CraftEntity)original).getHandle();
        nms.f(
            getTag(
                applied.toString()
            )
