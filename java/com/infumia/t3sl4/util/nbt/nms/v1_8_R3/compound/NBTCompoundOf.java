package com.infumia.t3sl4.util.nbt.nms.v1_8_R3.compound;

import com.infumia.t3sl4.util.nbt.nms.v1_8_R3.NBTBaseEnvelope;
import com.infumia.t3sl4.util.nbt.nms.v1_8_R3.base.NBTStringOf;
import com.infumia.t3sl4.util.nbt.nms.v1_8_R3.list.NBTByteListOf;
import com.infumia.t3sl4.util.nbt.nms.v1_8_R3.list.NBTTagListOf;
...
import com.infumia.t3sl4.util.nbt.nms.v1_8_R3.list.NBTIntListOf;
import com.infumia.t3sl4.util.nbt.nms.v1_8_R3.number.NBTIntOf;
...
public class NBTCompoundOf extends NBTBaseEnvelope<NBTTagCompound> implements NBTCompound<NBTTagCompound> {
    ...
    public void set(@NotNull String key, @NotNull NBTBase value) {
        if (!(value.value() instanceof net.minecraft.server.v1_8_R3.NBTBase))
            return;

        value().set(key, (net.minecraft.server.v1_8_R3.NBTBase) value.value());
    }
    ...
    public NBTBase get(@NotNull String key) {
        return new MapOf<>(
            new Mapped<>(
                value -> {
                    final net.minecraft.server.v1_8_R3.NBTBase base = value().get(value);
                    if (base == null)
                    ...
                    switch (base.getTypeId()) {
                        ...
                        case 1:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R3.number.NBTByteOf((NBTTagByte) base));
                        case 2:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R3.number.NBTShortOf((NBTTagShort) base));
                        case 3:
                            return new MapEntry<>(key, new NBTIntOf((NBTTagInt) base));
                        case 4:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R3.number.NBTLongOf((NBTTagLong) base));
                        case 5:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R3.number.NBTFloatOf((NBTTagFloat) base));
                        case 6:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R3.number.NBTDoubleOf((NBTTagDouble) base));
                        case 7:
                            return new MapEntry<>(key, new NBTByteListOf((NBTTagByteArray) base));
                        case 8:
                            return new MapEntry<>(key, new NBTStringOf((NBTTagString) base));
                        case 9:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R3.list.NBTTagListOf((NBTTagList) base));
                        case 10:
