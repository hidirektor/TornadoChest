...
import com.infumia.t3sl4.util.nbt.nms.v1_15_R1.compound.NBTCompoundOf;
...
public class NBTRegistry1_15_R1 implements NBTRegistry {
    ...
    public Entity toEntity(@NotNull Entity original, @NotNull NBTCompound applied) {
        net.minecraft.server.v1_15_R1.Entity nms = ((CraftEntity)original).getHandle();
        nms.f(
            getTag(
                applied.toString()
            )
