package com.infumia.t3sl4.util.nbt.nms.v1_8_R1.compound;

import com.infumia.t3sl4.util.nbt.nms.v1_8_R1.NBTBaseEnvelope;
import com.infumia.t3sl4.util.nbt.nms.v1_8_R1.base.NBTStringOf;
import com.infumia.t3sl4.util.nbt.nms.v1_8_R1.list.NBTByteListOf;
import com.infumia.t3sl4.util.nbt.nms.v1_8_R1.list.NBTIntListOf;
import com.infumia.t3sl4.util.nbt.nms.v1_8_R1.list.NBTTagListOf;
import com.infumia.t3sl4.util.nbt.nms.v1_8_R1.number.NBTDoubleOf;
...
public class NBTCompoundOf extends NBTBaseEnvelope<NBTTagCompound> implements NBTCompound<NBTTagCompound> {
    ...
    public void set(@NotNull String key, @NotNull NBTBase value) {
        if (!(value.value() instanceof net.minecraft.server.v1_8_R1.NBTBase))
            return;

        value().set(key, (net.minecraft.server.v1_8_R1.NBTBase) value.value());
    }
    ...
    public NBTBase get(@NotNull String key) {
        return new MapOf<>(
            new Mapped<>(
                value -> {
                    final net.minecraft.server.v1_8_R1.NBTBase base = value().get(value);
                    if (base == null)
                    ...
                    switch (base.getTypeId()) {
                        ...
                        case 1:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R1.number.NBTByteOf((NBTTagByte) base));
                        case 2:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R1.number.NBTShortOf((NBTTagShort) base));
                        case 3:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R1.number.NBTIntOf((NBTTagInt) base));
                        case 4:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R1.number.NBTLongOf((NBTTagLong) base));
                        case 5:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R1.number.NBTFloatOf((NBTTagFloat) base));
                        case 6:
                        ...
                        case 9:
                            return new MapEntry<>(key, new com.infumia.t3sl4.util.nbt.nms.v1_8_R1.list.NBTTagListOf((NBTTagList) base));
                        case 10:
