...
import io.github.portlek.nbt.nms.v1_14_R1.compound.NBTCompoundOf;
...
public abstract class NBTListEnvelope<V extends NBTBase, T extends NBTList<V>> extends NBTBaseEnvelope<T> implements io.github.portlek.nbt.api.NBTList<V, T> {
