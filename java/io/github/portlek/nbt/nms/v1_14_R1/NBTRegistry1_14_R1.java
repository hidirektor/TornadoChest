...
public class NBTRegistry1_14_R1 implements NBTRegistry {
    ...
    public NBTCompound toCompound(@NotNull CreatureSpawner creatureSpawner) {
        ...
        return new NBTCompoundOf(spawner.b());
    }
    ...
    public org.bukkit.entity.Entity toEntity(@NotNull Entity original, @NotNull NBTCompound applied) {
        net.minecraft.server.v1_14_R1.Entity nms = ((CraftEntity)original).getHandle();
        nms.f(
            getTag(
                applied.toString()
            )
